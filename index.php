    ...
    <div class="navigation">
      <div class="container">
        ...
        <div class="main">
          <div class="menu">
            <ul class="menu__ul">
              <li class="menu__item"><a href="#" class="menu__btn" src="#" name="phone">Смартфоны</a></li>
              <li class="menu__item"><a href="#" class="menu__btn" src="#" name="pc">Компьютеры</a></li>
              <li class="menu__item"><a href="#" class="menu__btn" src="#" name="notebook">Ноутбуки</a></li>
              <li class="menu__item"><a href="#" class="menu__btn" src="#" name="tablet">Планшеты</a></li>
              <li class="menu__item"><a href="#" class="menu__btn" src="#" name="technic">Бытовая техника</a></li>
              <li class="menu__item"><a href="#" class="menu__btn" src="#" name="tv">Телевизоры</a></li>
            </ul>
          </div>
