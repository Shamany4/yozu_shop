        ...
        <div class="main">
            <div class="main-wrap">
              <h2 class="main__title">Контакты:</h2>
                <p class="main__desc">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima id magnam ut voluptatibus deserunt sapiente officia, accusamus consequuntur. Consequatur labore fugit commodi voluptatum ratione? Hic totam, iste quod corporis eum officia dicta?</p>
                <span class="main__phone">8-800-555-5050 — С 8:00 до 20:00</span>
                <span class="main__phone">8-465-123-0648 — С 11:00 до 17:00</span>
            </div>
        </div>
      </div>
    </div>
